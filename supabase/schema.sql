...
-- ============================================
-- 20260706 상품·가격 카탈로그 + 예약 단가 스냅샷
-- (아래 정의가 위쪽의 booking_options_struct / submit_booking / admin_save_booking 를 대체함)
-- 상세: supabase/migrations/20260706_pricing_catalog.sql
-- ============================================
-- ============================================
...
-- ============================================
-- 20260706b 상품·가격 2단계: 손님용 옵션 추가/삭제 (아래가 위 submit_booking/pricing_public 대체)
-- 상세: supabase/migrations/20260706b_pricing_add_options.sql
-- ============================================
-- ============================================
...
-- ============================================
-- 20260813 계약금 입금확인 시각(deposit_paid_at) — 예약탭 '신규' 3일 유예 노출용
-- 상세: supabase/migrations/20260813_deposit_paid_at.sql
-- ============================================
